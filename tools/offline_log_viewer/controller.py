...
def read_topic_properties_serde(rdr: Reader, version):
    ...
    if version >= 1:
        topic_properties |= {
            "read_replica": rdr.read_optional(Reader.read_bool),
            "read_replica_bucket": rdr.read_optional(Reader.read_string),
            "remote_topic_properties": rdr.read_optional(
                read_remote_topic_properties_serde
            ),
        }
    if version >= 2:
        topic_properties |= {
    ...
    if version >= 3:
        topic_properties |= {
            "retention_local_target_bytes": rdr.read_tristate(Reader.read_uint64),
            "retention_local_target_ms": rdr.read_tristate(Reader.read_uint64),
            "remote_delete": rdr.read_bool(),
        }

    if version >= 4:
        topic_properties |= {"segment_ms": rdr.read_tristate(Reader.read_uint64)}
    if version >= 5:
        topic_properties |= {
            "record_key_schema_id_validation": rdr.read_optional(Reader.read_bool)
        }
        topic_properties |= {
            "record_key_schema_id_validation_compat": rdr.read_optional(
                Reader.read_bool
            )
        }
        topic_properties |= {
            "record_key_subject_name_strategy": rdr.read_optional(
                Reader.read_serde_enum
            )
        }
        topic_properties |= {
            "record_key_subject_name_strategy_compat": rdr.read_optional(
                Reader.read_serde_enum
            )
        }
        topic_properties |= {
            "record_value_schema_id_validation": rdr.read_optional(Reader.read_bool)
        }
        topic_properties |= {
            "record_value_schema_id_validation_compat": rdr.read_optional(
                Reader.read_bool
            )
        }
        topic_properties |= {
            "record_value_subject_name_strategy": rdr.read_optional(
                Reader.read_serde_enum
            )
        }
        topic_properties |= {
            "record_value_subject_name_strategy_compat": rdr.read_optional(
                Reader.read_serde_enum
            )
        }
    if version >= 6:
        topic_properties |= {
            "initial_retention_local_target_bytes": rdr.read_tristate(
                Reader.read_uint64
            ),
            "initial_retention_local_target_ms": rdr.read_tristate(Reader.read_uint64),
        }
    if version >= 7:
        topic_properties |= {
    ...
    if version >= 11:
        topic_properties |= {
            ...
            "iceberg_invalid_record_action": rdr.read_optional(Reader.read_serde_enum),
            "iceberg_target_lag_ms": rdr.read_optional(Reader.read_int64),
...
def read_topic_config(rdr: Reader, version):
    ...
    decoded["tp_id"] = rdr.read_optional(Reader.read_uuid) if version >= 3 else None
...
def read_topic_configuration_assignment_serde(rdr: Reader):
    return rdr.read_envelope(
        lambda rdr, _: {
            "cfg": rdr.read_envelope(read_topic_config, 3),
            "assignments": rdr.read_serde_vector(
                lambda r: r.read_envelope(
                    lambda ir, _: {
                        "group": ir.read_int64(),
                        "id": ir.read_int32(),
                        "replicas": ir.read_serde_vector(
                            lambda iir: {
...
def read_incremental_topic_update_serde(rdr: Reader):
    def incr_topic_upd(rdr: Reader, version):
        incr_obj = {
            "compression": read_property_update_serde(
                rdr, lambda r: r.read_optional(Reader.read_serde_enum)
            ),
            "cleanup_policy_bitflags": read_property_update_serde(
                rdr, lambda r: r.read_optional(Reader.read_serde_enum)
            ),
            "compaction_strategy": read_property_update_serde(
                rdr, lambda r: r.read_optional(Reader.read_serde_enum)
            ),
            "timestamp_type": read_property_update_serde(
                rdr, lambda r: r.read_optional(Reader.read_serde_enum)
            ),
            "segment_size": read_property_update_serde(
                rdr, lambda r: r.read_optional(Reader.read_uint64)
            ),
            "retention_bytes": read_property_update_serde(
                rdr, lambda r: r.read_tristate(Reader.read_uint64)
            ),
            "retention_duration": read_property_update_serde(
                rdr, lambda r: r.read_tristate(Reader.read_int64)
            ),
            "shadow_indexing": read_property_update_serde(
                rdr, lambda r: r.read_optional(Reader.read_serde_enum)
            ),
        }
        ...
        if version >= 2:
            incr_obj |= {
                "batch_max_bytes": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_uint32)
                ),
                "retention_local_target_bytes": read_property_update_serde(
                    rdr, lambda r: r.read_tristate(Reader.read_uint64)
                ),
                "retention_local_target_ms": read_property_update_serde(
                    rdr, lambda r: r.read_tristate(Reader.read_uint64)
                ),
                "remote_delete": read_property_update_serde(rdr, Reader.read_bool),
            }
        if version >= 3:
            incr_obj |= {
                "segment_ms": read_property_update_serde(
                    rdr, lambda r: r.read_tristate(Reader.read_uint64)
                )
            }
        if version >= 4:
            incr_obj |= {
                "record_key_schema_id_validation": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_bool)
                )
            }
            incr_obj |= {
                "record_key_schema_id_validation_compat": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_bool)
                )
            }
            incr_obj |= {
                "record_key_subject_name_strategy": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_serde_enum)
                )
            }
            incr_obj |= {
                "record_key_subject_name_strategy_compat": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_serde_enum)
                )
            }
            incr_obj |= {
                "record_value_schema_id_validation": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_bool)
                )
            }
            incr_obj |= {
                "record_value_schema_id_validation_compat": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_bool)
                )
            }
            incr_obj |= {
                "record_value_subject_name_strategy": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_serde_enum)
                )
            }
            incr_obj |= {
                "record_value_subject_name_strategy_compat": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_serde_enum)
                )
            }
        if version >= 5:
            incr_obj |= {
                "initial_retention_local_target_bytes": read_property_update_serde(
                    rdr, lambda r: r.read_tristate(Reader.read_uint64)
                ),
                "initial_retention_local_target_ms": read_property_update_serde(
                    rdr, lambda r: r.read_tristate(Reader.read_uint64)
                ),
            }
        if version >= 6:
            incr_obj |= {
                "write_caching": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_serde_enum)
                ),
                "flush_ms": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_int64)
                ),
                "flush_bytes": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_int64)
                ),
            }
        if version >= 7:
            incr_obj |= {
                "iceberg_mode": read_property_update_serde(rdr, read_iceberg_mode),
                "leaders_preference": read_property_update_serde(
                    rdr, lambda r: r.read_optional(read_leaders_preference)
                ),
                "iceberg_delete": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_bool)
                ),
            }
        if version >= 8:
            incr_obj |= {
                "iceberg_partition_spec": read_property_update_serde(
                    rdr, lambda r: r.read_optional(Reader.read_string)
                ),
                "topic_id": read_property_update_serde(
...
def read_create_partitions_serde(rdr: Reader):
    return rdr.read_envelope(
        lambda rdr, _: {
            "cfg": rdr.read_envelope(
                lambda rdr, _: {
                    "namespace": rdr.read_string(),
                    "topic": rdr.read_string(),
                    "new_total_partition_count": rdr.read_int32(),
                    "custom_assignments": rdr.read_serde_vector(
                        lambda r: r.read_serde_vector(Reader.read_int32)
                    ),
                }
            ),
            "assignments": rdr.read_serde_vector(
...
def read_acl_binding_filter_serde(k_rdr: Reader):
    ...
    return k_rdr.read_envelope(
        lambda k_rdr, _: {
            "pattern": {
                "resource": k_rdr.read_optional(
                    lambda k_rdr: decode_acl_resource(k_rdr.read_serde_enum())
                ),
                "name": k_rdr.read_optional(Reader.read_string),
                "pattern": k_rdr.read_optional(
                    lambda k_rdr: decode_serialized_pattern_type(
                        k_rdr.read_serde_enum()
                    )
                ),
            },
            "acl": k_rdr.read_envelope(
                lambda k_rdr, _: {
                    "principal": k_rdr.read_optional(
                        lambda k_rdr: k_rdr.read_envelope(
                            lambda k_rdr, _: {
                                "type": decode_acl_principal_type(
                                    k_rdr.read_serde_enum()
                                ),
                    ...
                    "host": k_rdr.read_optional(
                        lambda k_rdr: k_rdr.read_envelope(
                            lambda k_rdr, _: {
                                "addr": k_rdr.read_optional(
                                    lambda k_rdr: {
                                        "ipv4": k_rdr.read_bool(),
                                        "data": k_rdr.read_iobuf().hex(),
                                    }
                    ...
                    "operation": k_rdr.read_optional(
                        lambda k_rdr: decode_acl_operation(k_rdr.read_serde_enum())
                    ),
                    "permission": k_rdr.read_optional(
                        lambda k_rdr: decode_acl_permission(k_rdr.read_serde_enum())
                    ),
                }
            ),
        }
...
def decode_acl_command_serde(k_rdr: Reader, rdr: Reader):
    ...
    if cmd["type"] == 8:
        ...
        cmd |= k_rdr.read_envelope(
            lambda k_rdr, _: {
                "filters": k_rdr.read_serde_vector(read_acl_binding_filter_serde)
            }
        )
...
def decode_config_command_serde(k_rdr: Reader, rdr: Reader):
    ...
    if cmd["type"] == 0:
        ...
        cmd |= rdr.read_envelope(
            lambda rdr, _: {
                "upsert": rdr.read_serde_vector(
                    lambda rdr: rdr.read_envelope(
                        lambda rdr, _: {"k": rdr.read_string(), "v": rdr.read_string()}
                    )
                ),
                "remove": rdr.read_serde_vector(Reader.read_string),
            }
        )
    elif cmd["type"] == 1:
...
def decode_feature_command_serde(k_rdr: Reader, rdr: Reader):
    ...
    if cmd["type"] == 0:
        ...
        cmd |= k_rdr.read_envelope(
            lambda k_rdr, _: {
                "cluster_version": k_rdr.read_int64(),
                "actions": k_rdr.read_serde_vector(
                    lambda k_rdr: k_rdr.read_envelope(
                        lambda k_rdr, _: {
        ...
        cmd |= k_rdr.read_envelope(
            lambda k_rdr, _: {
                "redpanda_license": k_rdr.read_envelope(
                    decode_license_t, reader_version=1
                )
            }
        )
    return cmd
...
def decode_node_management_command(k_rdr: Reader, rdr: Reader):
    cmd = {"type": rdr.read_int8()}
    if cmd["type"] == 0:
        cmd |= {"type_string": "decommission_node", "node_id": k_rdr.read_int32()}
        rdr.read_int8()
    elif cmd["type"] == 1:
        cmd |= {"type_string": "recommission_node", "node_id": k_rdr.read_int32()}
        rdr.read_int8()
    elif cmd["type"] == 2:
        cmd |= {"type_string": "finish_reallocations", "node_id": k_rdr.read_int32()}
        rdr.read_int8()
    elif cmd["type"] == 3:
        cmd |= {
...
def decode_bootstrap_cluster_cmd_data(rdr: Reader, version):
    decoded = {
        ...
        "nodes_by_uuid": rdr.read_serde_map(Reader.read_uuid, Reader.read_int32),
    }
    if version >= 1:
...
def decode_cluster_bootstrap_command(k_rdr, rdr):
    ...
    if cmd["type"] == 0:
        ...
        cmd |= rdr.read_envelope(decode_bootstrap_cluster_cmd_data, reader_version=1)
...
def decode_record(batch, record, bin_dump: bool):
    ...
    ret["ts"] = datetime.datetime.utcfromtimestamp(header.first_ts / 1000.0).strftime(
        "%Y-%m-%d %H:%M:%S"
    )
    if bin_dump:
    ...
    if batch.type == BatchType.topic_management_cmd:
        ret["data"] = decode_adl_or_serde(
            k_rdr, rdr, decode_topic_command_adl, decode_topic_command_serde
        )
    if batch.type == BatchType.user_management_cmd:
        ret["data"] = decode_adl_or_serde(
            k_rdr, rdr, decode_user_command_adl, decode_user_command_serde
        )
    if batch.type == BatchType.acl_management_cmd:
        ret["data"] = decode_adl_or_serde(
            k_rdr, rdr, decode_acl_command_adl, decode_acl_command_serde
        )
    if batch.type == BatchType.cluster_config_cmd:
        ret["data"] = decode_adl_or_serde(
            k_rdr, rdr, decode_config_command_adl, decode_config_command_serde
        )
    if batch.type == BatchType.feature_update:
        ret["data"] = decode_adl_or_serde(
            k_rdr, rdr, decode_feature_command_adl, decode_feature_command_serde
        )
    if batch.type == BatchType.node_management_cmd:
        ret["data"] = decode_adl_or_serde(
            k_rdr, rdr, decode_node_management_command, decode_node_management_command
        )
...
def read_features_table_snapshot(rdr: Reader, version: int):
    ...
    ret |= {
        "states": rdr.read_serde_vector(
            lambda rdr: rdr.read_envelope(type_read=read_feature_state_snapshot)
        )
    }

    ret |= {
        "license": rdr.read_optional(
            lambda rdr: rdr.read_envelope(type_read=read_license, reader_version=1)
        )
    }
...
def read_topic_metadata_fields(rdr: Reader, v: int):
    v = {}
    v |= {"configuration": rdr.read_envelope(read_topic_config, reader_version=2)}
...
def read_role(rdr: Reader, version: int):
    return {
        "members": rdr.read_serde_vector(lambda r: r.read_envelope(read_role_member))
    }
...
def read_transform_metadata(rdr: Reader, version: int):
    return {
        ...
        "environment": rdr.read_serde_map(Reader.read_string, Reader.read_string),
        "uuid": rdr.read_uuid(),
...
class ControllerSnapshot:
    ...
    def read_features(self, rdr: Reader, version: int):
        return rdr.read_envelope(
            type_read=read_features_table_snapshot, reader_version=1
        )
    ...
    def read_members(self, rdr: Reader, version: int):
        def read_update_t(inner: Reader, v: int):
            ...
            ret |= {
                "decommission_update_revision": inner.read_optional(Reader.read_int64)
            }
            return ret
        ...
        def read_node_t(inner: Reader, v: int):
            ret = {}
            ret |= {
                "broker": inner.read_envelope(type_read=lambda r, _: read_broker(r))
            }
            ret |= {
                "state": inner.read_envelope(
                    type_read=lambda r, _: read_broker_state(r), reader_version=1
                )
            }
            return ret
        ...
        ret = {}
        ret |= {
            "node_ids_by_uuid": rdr.read_serde_map(Reader.read_uuid, Reader.read_int32)
        }
        ret |= {"next_assigned_id": rdr.read_int32()}
        ret |= {
            "nodes": rdr.read_serde_map(
                Reader.read_int32, lambda r: r.read_envelope(type_read=read_node_t)
            )
        }

        ret |= {
            "removed_nodes": rdr.read_serde_map(
                Reader.read_int32, lambda r: r.read_envelope(type_read=read_node_t)
            )
        }
        ret |= {
            "removed_nodes_still_in_raft0": rdr.read_serde_vector(Reader.read_int32)
        }
        ret |= {
            "in_progress_updates": rdr.read_serde_map(
                Reader.read_int32, lambda r: r.read_envelope(type_read=read_update_t)
            )
        }
    ...
    def read_config(self, rdr: Reader, version: int):
        ...
        ret |= {
            "values": rdr.read_serde_map(
                k_reader=Reader.read_string, v_reader=Reader.read_string
            )
        }
        ret |= {
            "nodes_status": rdr.read_serde_vector(
    ...
    def read_topics(self, rdr: Reader, version: int):
        ...
        def read_partition_t(rdr: Reader, version: int):
            ...
            v |= {
                "replica_revisions": rdr.read_serde_map(
                    Reader.read_int32, Reader.read_int64
                )
            }
        ...
        def read_update_t(rdr: Reader, version: int):
            v = {}
            v |= {"target_assignment": rdr.read_serde_vector(read_broker_shard)}
        ...
        def read_topic_t(rdr: Reader, version: int):
            v = {}
            v |= {"metadata_fields": rdr.read_envelope(read_topic_metadata_fields)}
            v |= {
                "partitions": rdr.read_serde_map(
                    Reader.read_int32,
                    lambda r: r.read_envelope(type_read=read_partition_t),
                )
            }
            v |= {
                "updates": rdr.read_serde_map(
                    Reader.read_int32,
                    lambda r: r.read_envelope(type_read=read_update_t),
                )
            }
            v |= {
                "disabled_set": rdr.read_optional(
        ...
        v = {}
        v |= {
            "topics": rdr.read_serde_map(
                read_tp_ns_to_str,
                lambda r: r.read_envelope(type_read=read_topic_t, reader_version=1),
            )
        }
        ...
        v |= {
            "lifecycle_markers": rdr.read_serde_map(
        ...
        v |= {
            "force_recoverable_partitions": rdr.read_serde_map(
                read_ntp_to_str,
    ...
    def read_security(self, rdr: Reader, version: int):
        def read_named_role_t(rdr: Reader, version: int):
            return {"name": rdr.read_string(), "role": rdr.read_envelope(read_role)}

        r = {"user_credentials": rdr.read_serde_vector(decode_user_and_credential)}

        r |= {"acls": rdr.read_serde_vector(read_acl_binding_serde)}
        if version > 0:
            r |= {
                "roles": rdr.read_serde_vector(
    ...
    def read_metrics_reporter(self, rdr: Reader, version: int):
        return rdr.read_envelope(
            lambda r, _: {"uuid": r.read_string(), "creation_ts": r.read_int64()}
        )

    def read_plugins(self, rdr: Reader, version: int):
        return rdr.read_serde_map(
            Reader.read_int64,
            lambda r: r.read_envelope(read_transform_metadata, reader_version=1),
        )
    ...
    def read_cluster_recovery(self, rdr: Reader, version: int):
        def read_cluster_metadata_manifest(rdr: Reader, version: int):
            ...
            r |= {
                "offsets_snapshots_by_partition": rdr.read_vector(
                    lambda r: r.read_vector(Reader.read_string)
                )
            }
            return r
        ...
        def read_cluster_recovery_state(rdr: Reader, version: int):
            ...
            r |= {"manifest": rdr.read_envelope(read_cluster_metadata_manifest)}
        ...
        return {
            "recovery_states": rdr.read_serde_vector(
    ...
    def read_snapshot(self, rdr: Reader):
        ...
        data["metrics_reporter"] = rdr.read_envelope(
            type_read=lambda r, v: self.read_metrics_reporter(r, v), reader_version=0
        )
        ...
        data["cluster_recovery"] = rdr.read_envelope(
            type_read=lambda r, v: self.read_cluster_recovery(r, v), reader_version=0
        )
