...
class DescribeTopicsTest(RedpandaTest):
    ...
    def test_describe_topics(self):
        ...
        topics = [
            TopicSpec(
                partition_count=random.randint(1, 20),
        ...
        def check():
            ...
            topics_described = [client.describe_topic(topic.name) for topic in topics]
    ...
    def test_describe_topics_with_documentation_and_types(self):
        ...
        properties = {
            "cleanup.policy": ConfigProperty(
                config_type="STRING",
                value="DELETE",
                doc_string="default cleanup policy for topic logs. the topic property `cleanup.policy` overrides the value of `log_cleanup_policy` at the topic level.",
                source_type="DYNAMIC_TOPIC_CONFIG",
            ),
            "compression.type": ConfigProperty(
                config_type="STRING",
                value="producer",
                doc_string="Default topic compression type. The topic property `compression.type` overrides the value of `log_compression_type` at the topic level.",
            ),
            "max.message.bytes": ConfigProperty(
                config_type="INT",
                value="1048576",
                doc_string="Maximum size of a batch processed by the server. If the batch is compressed, the limit applies to the compressed batch size.",
            ),
            "message.timestamp.type": ConfigProperty(
                config_type="STRING",
                value="CreateTime",
                doc_string="Default timestamp type for topic messages (CreateTime or LogAppendTime). The topic property `message.timestamp.type` overrides the value of `log_message_timestamp_type` at the topic level.",
            ),
            "redpanda.remote.delete": ConfigProperty(
                config_type="BOOLEAN",
                value="true",
                doc_string="Controls whether topic deletion should imply deletion in S3",
            ),
            "redpanda.remote.read": ConfigProperty(
                config_type="BOOLEAN",
                value="false",
                doc_string="Default remote read config value for new topics",
            ),
            "redpanda.remote.write": ConfigProperty(
                config_type="BOOLEAN",
                value="false",
                doc_string="Default remote write value for new topics",
            ),
            "retention.bytes": ConfigProperty(
                config_type="LONG",
                value="-1",
                doc_string="Default maximum number of bytes per partition on disk before triggering "
            ...
            "retention.local.target.bytes": ConfigProperty(
                config_type="LONG",
                value="-1",
                doc_string="Local retention size target for partitions of topics with object "
            ...
            "retention.local.target.ms": ConfigProperty(
                config_type="LONG",
                value="86400000",
                doc_string="Local retention time target for partitions of topics with object "
            ...
            "retention.ms": ConfigProperty(
                config_type="LONG",
                value="604800000",
                doc_string="The amount of time to keep a log file before deleting it (in "
                "milliseconds). If set to `-1`, no time limit is applied. This is a "
                "cluster-wide default when a topic does not set or disable "
                "`retention.ms`.",
            ),
            "segment.bytes": ConfigProperty(
                config_type="LONG",
                value="134217728",
                doc_string="Default log segment size in bytes for topics which do not set segment.bytes",
            ),
            "segment.ms": ConfigProperty(
                config_type="LONG",
                value="1209600000",  # 2 weeks in ms
                doc_string="Default lifetime of log segments. If `null`, the property is disabled, "
            ...
            "redpanda.key.schema.id.validation": ConfigProperty(
                config_type="BOOLEAN",
                value="false",
                doc_string="Enable validation of the schema id for keys on a record",
            ),
            "redpanda.key.subject.name.strategy": ConfigProperty(
                config_type="STRING",
                value="TopicNameStrategy",
                doc_string="The subject name strategy for keys if redpanda.key.schema.id.validation is enabled",
            ),
            "redpanda.value.schema.id.validation": ConfigProperty(
                config_type="BOOLEAN",
                value="false",
                doc_string="Enable validation of the schema id for values on a record",
            ),
            "redpanda.value.subject.name.strategy": ConfigProperty(
                config_type="STRING",
                value="TopicNameStrategy",
                doc_string="The subject name strategy for values if redpanda.value.schema.id.validation is enabled",
            ),
            "confluent.key.schema.validation": ConfigProperty(
                config_type="BOOLEAN",
                value="false",
                doc_string="Enable validation of the schema id for keys on a record",
            ),
            "confluent.key.subject.name.strategy": ConfigProperty(
                config_type="STRING",
                value="io.confluent.kafka.serializers.subject.TopicNameStrategy",
                doc_string="The subject name strategy for keys if confluent.key.schema.validation is enabled",
            ),
            "confluent.value.schema.validation": ConfigProperty(
                config_type="BOOLEAN",
                value="false",
                doc_string="Enable validation of the schema id for values on a record",
            ),
            "confluent.value.subject.name.strategy": ConfigProperty(
                config_type="STRING",
                value="io.confluent.kafka.serializers.subject.TopicNameStrategy",
            ...
            "initial.retention.local.target.bytes": ConfigProperty(
                config_type="LONG",
                value="-1",
                doc_string="Initial local retention size target for partitions of topics with Tiered Storage enabled. If no initial local target retention is configured all locally retained data will be delivered to learner when joining partition replica set.",
            ),
            "initial.retention.local.target.ms": ConfigProperty(
                config_type="LONG",
                value="-1",
                doc_string="Initial local retention time target for partitions of topics with Tiered Storage enabled. If no initial local target retention is configured all locally retained data will be delivered to learner when joining partition replica set.",
            ),
            "write.caching": ConfigProperty(
                config_type="STRING",
                value="false",
                doc_string="The default write caching mode to apply to user topics. Write caching "
            ...
            "flush.ms": ConfigProperty(
                config_type="LONG",
                value="100",
                doc_string="Maximum delay between two subsequent flushes. After this delay, the log is automatically force flushed.",
            ),
            "flush.bytes": ConfigProperty(
                config_type="LONG",
                value="262144",
                doc_string="Maximum number of bytes that are not flushed per partition. If the configured threshold is reached, the log is automatically flushed even if it has not been explicitly requested.",
            ),
            "redpanda.iceberg.mode": ConfigProperty(
                config_type="STRING",
                value="disabled",
                doc_string="Iceberg enablement mode for the topic.",
            ),
            "redpanda.leaders.preference": ConfigProperty(
                config_type="STRING",
                value="none",
            ...
            "delete.retention.ms": ConfigProperty(
                config_type="LONG",
                value="-1",
                doc_string="The retention time for tombstone records and transaction markers in a compacted topic.",
            ),
            "redpanda.iceberg.delete": ConfigProperty(
                config_type="BOOLEAN",
                value="true",
                doc_string="If true, delete the corresponding Iceberg table when deleting the topic.",
            ),
            "redpanda.iceberg.partition.spec": ConfigProperty(
                config_type="STRING",
                value="",
                doc_string="Partition spec of the corresponding Iceberg table.",
            ),
            "redpanda.iceberg.invalid.record.action": ConfigProperty(
                config_type="STRING",
                value="dlq_table",
                doc_string="Action to take when an invalid record is encountered.",
            ),
            ...
            "redpanda.remote.allowgaps": ConfigProperty(
                config_type="BOOLEAN",
                value="false",
                doc_string="controls the eviction of locally-stored log segments when "
            ...
            "min.compaction.lag.ms": ConfigProperty(
                config_type="LONG",
                value="0",
                doc_string="For a compacted topic, the minimum time a message remains uncompacted "
                "in the log. The topic property `min.compaction.lag.ms` overrides "
                "this property.",
            ),
            "max.compaction.lag.ms": ConfigProperty(
                config_type="LONG",
                value="9223372036854",
                doc_string="For a compacted topic, the maximum time a message remains ineligible "
        ...
        self.logger.debug(f"Table separator {last_pos} {len(output[last_pos])}")
        ...
        for i in range(0, len(doc_lines) // 3):
            ...
            self.logger.debug(f"Doc line {name_line}, {doc_string}, {empty_line}")
